              ...
              <details className="group">
                <summary className="list-none [&::-webkit-details-marker]:hidden [&::marker]:hidden">
                  <div className="flex items-center gap-3">
                    ...
                    <h3 className="text-sm text-gray-700 dark:text-white transition-colors flex-1">
                      {notice.title}
                    </h3>
          ...
          <div className="flex flex-col items-center justify-center h-full min-h-[300px] w-full text-center">
            ...
            {mainNotice ? (
              <>
                ...
                <h3 className="text-gray-800 dark:text-white font-nanumNeo text-lg mb-2 line-clamp-2">
                  {mainNotice.title}
                </h3>
