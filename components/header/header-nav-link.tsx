  ...
  return (
    <Link
      ...
      className={cn(
        ...
        isActive
          ? "bg-brand/5 dark:bg-dark-brand/5 text-brand dark:text-dark-brand"
          : "text-muted-foreground hover:bg-brand/10 dark:hover:bg-dark-brand/10 hover:text-brand dark:hover:text-dark-brand",
      )}
    >
