  ...
  const onSubmit = async (data: ForgotPasswordFormValues) => {
    ...
    try {
      const { error } = await supabase.auth.resetPasswordForEmail(data.email, {
        redirectTo: `${window.location.origin}/callback-email`,
      });
        ...
        <div className="border border-gray-200 p-6 rounded-lg font-nanumNeo">
          <div className="flex flex-col items-center text-center space-y-6">
            ...
            <div className="space-y-2">
              <h2 className="text-2xl text-gray-900">이메일을 확인해주세요</h2>
            ...
            <div className="w-full space-y-4 text-left bg-gray-50 p-4 rounded-lg">
              <div className="flex items-start gap-3">
                ...
                <div className="space-y-1">
                  <p className="text-sm text-gray-900 font-anyvid">
                    이메일을 확인해주세요
                  </p>
